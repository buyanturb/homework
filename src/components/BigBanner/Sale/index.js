...
const Sale = () =>
{
  ...
  <div className={css.saleWrapper} data-aos="fade-down">
    ...
    <button class="cursor-pointer rounded-lg text-lg	md:px-10 md:py-3 px-8 py-2 md:bg-white md:text-black bg-zinc-900 text-white m-auto block cursor-pointer mt-6 uppercase font-medium">shop now</button>
  </div>
	)
}
