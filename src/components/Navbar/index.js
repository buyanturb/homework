		...
		<div className="z-10 text-white">
            ...
            <div className="h-[53px] md:h-[88px] px-2 sm:px-11 flex items-center">
                ...
                <div className="flex items-center w-1/3 justify-end">
                    <input className="w-[260px] sm:block hidden placeholder:text-black block bg-white w-full border border-slate-300 rounded-md py-2 pl-3 pr-3 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm" placeholder="search" style={{ width: '260px' }} />
